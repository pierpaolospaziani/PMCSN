...
#ifdef V1
#include "Configurations/Finite/config_1.h"
#endif
#ifdef V2
#include "Configurations/Finite/config_2.h"
#endif
#ifdef V3
#include "Configurations/Finite/config_3.h"
#endif
#ifdef V4
#include "Configurations/Finite/config_ott.h"
#endif
...
int caso(int phase, int center_index){
  if (phase == 2){
    ...
    switch(center_index){
      case 0:
        return NUM_SERVER_C0_1;
      case 1:
        return NUM_SERVER_C1_1;
      case 2:
        return NUM_SERVER_C2_1;
      case 3:
        return NUM_SERVER_C3_1;
      case 4:
        return NUM_SERVER_C4_1;
      case 5:
        return NUM_SERVER_C5_1;
      case 6:
        return NUM_SERVER_C6_1;
    }
  }
  return 0;
}
